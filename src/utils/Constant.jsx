...
export const CHANNEL_PLAYLIST =`https://youtube.googleapis.com/youtube/v3/playlists?part=snippet%2CcontentDetails&maxResults=50&key=${GOOGLE_API_KEY}&channelId=`

export const  PLAYLIST =`https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet%2CcontentDetails&key=${GOOGLE_API_KEY}&maxResults=50&playlistId=`
